...
{
    [Theory(Skip = "doesn't work on linux"), AutoNSubstituteData]
    public async Task When_encrypting_and_decrypting_to_disk_Then_data_is_correct(DpapiService dpapiService,
